...
MEMORY_BASE_ADDR, MEMORY_SIZE_BYTES = 0x10000, 0x11000000
STDOUT_ADDR, HALT_ADDR, HALT_MAGIC_VALUE = 0x10000000, 0x100000, 0x5555
SYSCALL_EXIT, ECALL_INSTRUCTION, MAX_INSTRUCTION_COUNT = 93, b"\x73\x00\x00\x00", 100000
